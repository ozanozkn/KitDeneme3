//
//  BusLocationsResponseModel.swift
//  KitDeneme
//
//  Created by Ozan Özkan on 21.03.2024.
//

// This file was generated from JSON Schema using quicktype, do not modify it directly.
// To parse the JSON, add this file to your project and do:
//
//   let busLocationsResponseModel = try? JSONDecoder().decode(BusLocationsResponseModel.self, from: jsonData)

import Foundation

// MARK: - BusLocationsResponseModel
struct BusLocationsResponseModel: Codable {
    let lastUpdated: Int
